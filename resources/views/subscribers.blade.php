                                                ...
                                                @foreach ($subscribers ?? '' as $item)
                                                    <tr>
                                                        ...
                                                        <td class="project-actions text-center">
                                                            <a class="btn btn-info btn-block btn-sm" href="{{ route('edit-subscriber',['id' =>$item->id]) }}">
                                                                <i class="fas fa-pencil-alt">
                                                                </i>
                                                            </a>
                                                            <a class="btn btn-danger  btn-block btn-sm" href="{{ route('destroy-subscriber',['id' =>$item->id]) }}">
